...
<head>
  ...
  <style>
    :root{
      ...
      --night-2:#0d2d37;
      --white:#ffffff;
      --ring: 0 0 0 4px rgba(42,167,184,.18);
      --radius:22px;
    }
    *{box-sizing:border-box}
    ...
    /* Layout shell */
    .wrap{max-width:1120px;margin:auto;padding:28px 20px 80px}
    header{
      display:flex;align-items:center;justify-content:space-between;
      padding:6px 0 22px;
    }
    .brand{
      display:flex;align-items:center;gap:10px;font-weight:700;font-size:18px;color:var(--night);
      text-decoration:none
    }
    .brand svg{width:28px;height:28px}
    nav a{
      color:var(--muted);text-decoration:none;margin-left:26px;font-weight:500
    }
    ...
    h1{font-size:40px;margin:6px 0 6px}
    ...
    /* Footer */
    footer{
      margin-top:18px;background:var(--night);color:#cfe6eb;border-radius:24px;padding:28px
    }
    .foot-grid{
      display:grid;grid-template-columns:1.2fr .8fr .8fr;gap:28px;align-items:start
    }
    .logo-line{display:flex;align-items:center;gap:10px;margin-bottom:8px}
    .sm{display:flex;gap:10px;margin:10px 0 0}
    .dot{
      width:34px;height:34px;border-radius:50%;display:grid;place-items:center;background:#0f3a45;color:#dff6fa;font-size:14px
    }
    .fnav a{display:block;color:#cfe6eb;text-decoration:none;margin:6px 0}
    .fnav a:hover{color:#fff}
    .foot-note{font-size:13px;color:#9cc4cb;margin-top:6px}
...
<body>
  <div class="wrap">
    <header>
      <a class="brand" href="#">
        ...
        <svg viewBox="0 0 24 24" fill="none" aria-hidden="true">
          ...
          <circle cx="12" cy="12" r="5.2" stroke="#2aa7b8" stroke-width="2" fill="#fff"/>
    ...
    <main class="contact">
      <!-- Left: copy and quick contact info -->
      <section>
    ...
    <footer>
      <div class="foot-grid">
        ...
        <div class="fnav" aria-label="Company">
